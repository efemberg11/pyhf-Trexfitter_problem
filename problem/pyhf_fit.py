...
print('asimov_fit', ' ', model.config.channels, ' ', model.config.poi_name, ' ', bestfit[model.config.poi_index], " ", errors[model.config.poi_index])
model,data,bestfit,errors = fitresults('three_lep_presel_1jet')
print('data_fit', ' ', model.config.channels, ' ', model.config.poi_name, ' ', bestfit[model.config.poi_index], " ", errors[model.config.poi_index])
